...
export class CompromissoService {
  ...
  public inserir(
    contato: FormsCompromissoViewModel
  ): Observable<FormsCompromissoViewModel> {
    const resposta = this.http
      .post<FormsCompromissoViewModel>(
        this.apiUrl + 'compromissos',
        contato,
  ...
  public editar(
    ...
    const resposta = this.http
      .put<FormsCompromissoViewModel>(
        this.apiUrl + 'compromissos/' + contato.id,
        contato,
        this.obterHeadersAutorizacao()
      )
      .pipe(map(this.processarDados), catchError(this.processarFalha));
  ...
  public selecionarTodos(): Observable<ListarCompromissoViewModel[]> {
    const resposta = this.http
      .get<ListarCompromissoViewModel[]>(
        this.apiUrl + 'compromissos',
        this.obterHeadersAutorizacao()
      )
      .pipe(map(this.processarDados), catchError(this.processarFalha));
  ...
  public visualizarCompromissoCompletoPorId(
    id: string
  ): Observable<VisualizarCompromissoViewModel> {
    const resposta = this.http
      .get<VisualizarCompromissoViewModel>(
        this.apiUrl + 'compromissos/visualizacao-completa/' + id,
        this.obterHeadersAutorizacao()
      )
      .pipe(map(this.processarDados), catchError(this.processarFalha));
