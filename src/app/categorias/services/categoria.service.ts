...
export class CategoriaService {
  ...
  public inserir(
    contato: FormsCategoriaViewModel
  ): Observable<FormsCategoriaViewModel> {
    const resposta = this.http
      .post<FormsCategoriaViewModel>(
  ...
  public editar(
    ...
    const resposta = this.http
      .put<FormsCategoriaViewModel>(
        this.apiUrl + 'categorias/' + categoria.id,
        categoria,
        this.obterHeadersAutorizacao()
      )
      .pipe(map(this.processarDados), catchError(this.processarFalha));
  ...
  public visualizarCategoriaCompletaPorId(
    id: string
  ): Observable<VisualizarCategoriaViewModel> {
    const resposta = this.http
      .get<VisualizarCategoriaViewModel>(
        this.apiUrl + 'categorias/visualizacao-completa/' + id,
        this.obterHeadersAutorizacao()
      )
      .pipe(map(this.processarDados), catchError(this.processarFalha));
