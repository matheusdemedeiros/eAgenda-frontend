...
@Injectable()
export class VisualizarCompromissoResolver
  implements Resolve<VisualizarCompromissoViewModel>
{
  ...
  resolve(
    ...
    return this.compromissoService.visualizarCompromissoCompletoPorId(
      route.params['id']
    );
  }
}
